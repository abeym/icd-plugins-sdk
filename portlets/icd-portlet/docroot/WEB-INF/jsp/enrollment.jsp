		...
		<form method="post" action="<portlet:actionURL/>"
			...
			<div id="content_top">
					...
					<table>
						...
						<tr>
							<td><spring:message code="enrollment.organizationName"
								...
								name="organizationName" title="${vorganizationName}"></td>
						</tr>
						<tr>
						...
						<tr>
							<td><spring:message code="enrollment.organizationCity"
								...
								name="organizationCity" title="${vorganizationCity}"></td>
						</tr>
						<tr>
				...
				<div class="classMiddle">
					<table>
						<tr>
							<td><select multiple="multiple" name="top5HealthPlansByRev"></select>
							</td>
						</tr>
						<tr>
				...
				<div class="classRight">
					<table>
						<tr>
							<td><textarea rows="3" cols="5" name="top5DrgByRev"></textarea>
							</td>
						</tr>
						<tr>
				...
				<div class="classRightRepeat">
					<table>
						<tr>
							<td><textarea rows="3" cols="5" name="top5Icd9ByRev"></textarea>
							</td>
						</tr>
						<tr>
							<td><spring:message code="enrollment.icd9Dx1" var="vicd9Dx1" />
								<input type="text" name="icd9Dx1" title="${vicd9Dx1}"></td>
						</tr>
						<tr>
							<td><spring:message code="enrollment.icd9Dx2" var="vicd9Dx2" />
								<input type="text" name="icd9Dx2" title="${vicd9Dx2}"></td>
						</tr>
						<tr>
							<td><spring:message code="enrollment.icd9Dx3" var="vicd9Dx3" />
								<input type="text" name="icd9Dx3" title="${vicd9Dx3}"></td>
						</tr>
						<tr>
							<td><spring:message code="enrollment.icd9Dx4" var="vicd9Dx4" />
								<input type="text" name="icd9Dx4" title="${vicd9Dx4}"></td>
						</tr>
						<tr>
							<td><spring:message code="enrollment.icd9Dx5" var="vicd9Dx5" />
								<input type="text" name="icd9Dx5" title="${vicd9Dx5}"></td>
						</tr>
					...
					<table>
						...
						<tr>
							<td><spring:message
								...
								title="${vprimaryTestingContactTitle}"></td>
						</tr>
						<tr>
							<td><spring:message
								...
								title="${vprimaryTestingContactPhone}"></td>
						</tr>
						<tr>
							<td><spring:message
								...
								title="${vprimaryTestingContactEmail}"></td>
						</tr>
					</table>
				</div>
					...
					<table>
						...
						<tr>
							<td><spring:message
								...
								title="${vprimaryCodingContactTitle}"></td>
						</tr>
						<tr>
							<td><spring:message
								...
								title="${vprimaryCodingContactPhone}"></td>
						</tr>
						<tr>
							<td><spring:message
								...
								title="${vprimaryCodingContactEmail}"></td>
						</tr>
					</table>
				</div>
					...
					<table>
						...
						<tr>
							<td><spring:message
								...
								title="${vprimaryBillingContactTitle}"></td>
						</tr>
						<tr>
							<td><spring:message
								...
								title="${vprimaryBillingContactPhone}"></td>
						</tr>
						<tr>
							<td><spring:message
								...
								title="${vprimaryBillingContactEmail}"></td>
						</tr>
					</table>
				</div>
			</div>
