...
<div id="page_container">
		<form method="post" action="<portlet:actionURL/>"
			...
			<div class="section">
				<div class="small_col">
					<select name="selectedPortalUser" class="select_box">
						<option>Select portal user</option>
					</select> 
					<select name="selectedMedicalRecordId" class="select_box">
					...
					<select name="changeTestingState" class="select_box">
					...
					<textarea rows="3" cols="5" name="testingStateChangeNotes" class="textarea"></textarea>
				...
				<div class="small_col">
					...
					<input type="text" name="searchMedicalRecords"
						title="${vsearchMedicalRecords}" title="search Medical Records"
						size="27" class="input_box search" value="Search Medical Records">
				</div>
				<div class="small_col">
					<spring:message code="portalmanagement.searchPortalUsers"
						var="vsearchPortalUsers" />
					<input type="text" name="searchPortalUsers"
						title="${vsearchPortalUsers}" title="search Portal Users"
						size="27" class="input_box search" value="Search Portal Users">
				</div>
				<div class="ex_medium_col">
					<table width="102%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>
							<select name="icd9AdmittingDxControl" class="select_box">
							...
							<select name="icd10AdmittingDxPattern1" class="select_box">
							...
							<select name="icd10AdmittingDxPattern2" class="select_box">
							...
							<select name="icd10AdmittingDxPattern3" class="select_box">
						...
						<tr>
							<td>
							<select name="icd9PrincipalDxControl" class="select_box">
							...
							<td class="padding_le_10">
							<select name="icd10PrincipalDxPattern1" class="select_box">
							...
							<select name="icd10PrincipalDxPattern2" class="select_box">
							...
							<select name="icd10PrincipalDxPattern3" class="select_box">
						...
						<tr>
							<td>
							<select name="icd9PrincipalProcControl" class="select_box">
							...
							<td class="padding_le_10">
							<select name="icd9PrincipalPcsPattern1" class="select_box">
							...
							<select name="icd9PrincipalPcsPattern2" class="select_box">
							...
							<select name="icd9PrincipalPcsPattern3" class="select_box">
			...
			<div class="section">
				...
				<div class="small_col">
					<select name="codingAccuracy" class="select_box">
						<c:forEach items="${codingAccuracy}" var="refItem">
							<option value="<c:out value="${refItem.key}"/>">
								<c:out value="${refItem.value} " />
							</option>
						</c:forEach>
					</select> <select name="codingProficiency" class="select_box">
						<c:forEach items="${codingProficiency}" var="refItem">
							<option value="<c:out value="${refItem.key}"/>">
								<c:out value="${refItem.value} " />
							</option>
						</c:forEach>
					</select> <select name="clearinghouseAccuracy" class="select_box">
						<c:forEach items="${clearingHouseAccuracy}" var="refItem">
							<option value="<c:out value="${refItem.key}"/>">
								<c:out value="${refItem.value} " />
							</option>
						</c:forEach>
					</select> <select name="adjudicationRate" class="select_box">
